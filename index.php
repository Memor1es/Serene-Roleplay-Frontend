...
.srp-feature-container {
  padding-top: 3vh;
  padding-bottom: 6vh;
  background: #2e3138;
}

.srp-feature-container .uk-heading-line {
padding-bottom: 1vh;
 font-family: 'Lato', sans-serif;
}

.srp-feature-container i {
  font-size: 3rem;
  margin-top: 0.5vh;
}
...
<p>Discover unique features in San Andreas that allow for an Immersive roleplaying experience! From custom robberies to custom jobs and much more!</p>
    ...
    <div>
        <div class="uk-card uk-card-secondary uk-card-body">
            ...
            <p>Check out the newest edition to San Andreas! <br /> Anybody can access the gambling facility that gives its players an opportunity to lose their life savings!</p>
        </div>
    </div>
  </div>
